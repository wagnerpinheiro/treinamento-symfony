<?php
$view = TreinamentoSf\Bootstrap::getInstance()->getView();
?>
<h1>Demo 3: Backend MVC</h1>
...
<div class="container">
  ...
  <form action="index.php?go=Main/saveFuncionario" method="post">
    ...
    <div class="form-group">
      ...
      <select class="form-control" id="departamento" name="departamento_id">
        <option value=""></option>
        <?php
        foreach ($view->departamentos as $dpto){
...
<div class="container">
  ...
  <table class="table table-striped table-hover">
    ...
    <tbody>
      <?php                 
        foreach ($view->funcionarios as $func){
